...
CIn3 = composition(length,h,H,bx,wx,N,2.5e-9);
...
CAs3 = composition(length,h,H,by,wy,N,k*2.5e-9);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%plot(z,CIn0,z,CIn1,z,CIn2,z,CIn3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%E2 = offset*(E2 - E2(1,N*(H+h)/2/length)) + E2(1,N*(H+h)/2/length);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%plot(z,(Vc2+E2(1,N*(H+h)/2/length))/1.6e-19);
