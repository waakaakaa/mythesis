...
\Etitle{Fast Wavelength Switchable V-Coupled Cavity Semiconductor}
\Etitletl{Laser based on Quantum Well Intermixing Technology}
...
\chairman{陆璇辉~教授~浙江大学}
\commissionerA{庄飞~教授~杭州师范大学}
\commissionerB{乐孜纯~教授~浙江工业大学}
\commissionerC{章坚武~教授~杭州电子科技大学}
\commissionerD{董新永~教授~中国计量大学}
...
\Echairman{Xuanhui Lu~Professor~Zhejiang University}
\EcommissionerA{Fei Zhuang~professor~Hangzhou Normal University}
\EcommissionerB{Zichun Le~Professor~Zhejiang University of Technology}
\EcommissionerC{Jianwu Zhuang~Professor~Hangzhou Dianzi University}
\EcommissionerD{Xinyong Dong~Professor~China Jiliang University}
